  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        ...
        <button onClick={() => navigate('/')} className="text-indigo-600 hover:underline">Back to Shop</button>
      </div>
    );
  }
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-200 mb-12">
          ...
          {!user ? (
            <div className="bg-gray-50 p-4 rounded-xl flex items-center gap-3 text-gray-600">
              <ShieldAlert size={20} />
              <p>Please <span onClick={() => navigate('/login')} className="font-bold text-indigo-600 cursor-pointer hover:underline">log in</span> to leave a review.</p>
            </div>
          ) : (
