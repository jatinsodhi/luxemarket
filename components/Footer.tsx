        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><Link href="#" className="hover:text-indigo-400 transition-colors">New Arrivals</Link></li>
              <li><Link href="#" className="hover:text-indigo-400 transition-colors">Featured Brands</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><Link href="#" className="hover:text-indigo-400 transition-colors">Order Status</Link></li>
